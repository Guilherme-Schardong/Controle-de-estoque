 ...
 * @author Aluno
 */
public class labelLogin extends javax.swing.JFrame {

    /**
     * Creates new form labelLogin
     */
    public labelLogin() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(139, 139, 139)
                        .addComponent(buttonLogar, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void buttonLogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLogarActionPerformed
        ...
        valor = Double.parseDouble(txtSenha.getText());
        
        if((valor==123456) && txtUser.getText().equals("admin"))
        {
        ...
        {
         JOptionPane.showMessageDialog(null,"user ou senha invalidos","ERRO", JOptionPane.WARNING_MESSAGE);   
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(labelLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new labelLogin().setVisible(true);
            }
        });
    }
